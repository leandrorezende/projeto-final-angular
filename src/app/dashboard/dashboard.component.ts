...
//faz com que um variavel global do js seja acessivel dentro do typescript
//muito utilizado para variaveis externas
...
export class DashboardComponent implements OnInit {
  ...
  */
  ...
  /*
    Metodo chamado assim que a API de gráficos é inicializada 
